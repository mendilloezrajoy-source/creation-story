...
for(let i=1;i<=7;i++){let c=document.createElement('div');c.className='card';c.innerHTML=`<img src="${i}.png"><div class="drop" data-a="${i}">Drop Day Here</div>`;grid.appendChild(c);}
